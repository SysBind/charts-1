...
| `pgpool.disableLoadBalanceOnWrite`             | Specify load balance behavior after write queries appears                                                                                                            | `transaction`                                                |
| `pgpool.enablePoolHba`                         | If true, use pool_hba                                                                                                                                                | `true`                                                       |
| `pgpool.enablePoolPasswd`                      | If true, use pool_passwd                                                                                                                                             | `true`                                                       |
| `pgpool.numInitChildren`                       | The number of preforked Pgpool-II server processes. num_init_children is also the concurrent connections limit to Pgpool-II from clients.                            | `true`                                                       |
| **LDAP**                                        |                                                                                                                                                                                                 | `32`                                                         |
